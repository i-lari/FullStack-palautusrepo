describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('blog order is updated by likes', function() {
      cy.contains('new blog').click()
      ...
      cy.get('#url').type('uuäräl')
      cy.get('#create-button').click()
      //blogs titled blog1,blog2,blog3 created
      cy.contains('blog3').parent().find('#viewblog-button').click()
      cy.contains('blog2').parent().find('#viewblog-button').click()
      cy.contains('blog1').parent().find('#viewblog-button').click()
      cy.contains('blog3').parent().find('#like-button').click()
      cy.wait(100)
      cy.get('.blog').eq(0).contains('blog3')
      cy.contains('blog3').parent().find('#like-button').click()
      cy.wait(100)
      cy.get('.blog').eq(0).contains('blog3')
      cy.contains('blog2').parent().find('#like-button').click()
      cy.wait(100)
      cy.get('.blog').eq(0).contains('blog3')
      cy.get('.blog').eq(1).contains('blog2')
      cy.contains('blog1').parent().find('#like-button').click()
      cy.wait(100)
      cy.contains('blog1').parent().find('#like-button').click()
      cy.wait(100)
      cy.contains('blog1').parent().find('#like-button').click()
      ...
      cy.get('.blog').eq(2).contains('blog2')
    })
  })
})